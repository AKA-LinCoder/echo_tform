...
class TFormField extends StatefulWidget {
  ...
  const TFormField({Key? key, required this.row}) : super(key: key);
...
class _TFormFieldState extends State<TFormField> {
  ...
  Widget get _selectorIcon =>
      row.fieldConfig?.selectorIcon ?? const Icon(Icons.keyboard_arrow_right);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        row.fieldConfig?.divider ?? const SizedBox.shrink()
      ],
    );
  }
